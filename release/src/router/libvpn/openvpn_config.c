...
// Tunnel options
	...
	snprintf(conf->username, sizeof(conf->username), nvram_pf_safe_get(prefix, "username"));

	snprintf(conf->password, sizeof(conf->password), nvram_pf_safe_get(prefix, "password"));
